...
import { addPost, cancelEditingPost, endEditingPost } from 'pages/blog/blog.slice'
import { RootState } from 'store'
const inittalStae: Post = {
  id: '',
  description: '',
  featuredImage: '',
  publishDate: '',
...
export default function CreatePost() {
  ...
  const [formData, setFormData] = useState<Post>(inittalStae)
  useEffect(() => {
    if (editingPost !== null) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingPost) {
      dispatch(endEditingPost({ ...formData, id: editingPost.id }))
    } else {
      dispatch(addPost(formData))
    }
    setFormData(inittalStae)
  }
